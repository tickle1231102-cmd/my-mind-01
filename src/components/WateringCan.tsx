        ...
        >
          <defs>
            <linearGradient id="wcBody" x1="20" y1="14" x2="52" y2="44">
              <stop offset="0%" stopColor="#b8d4c0" />
              <stop offset="100%" stopColor="#8fad7a" />
            </linearGradient>
            <linearGradient id="wcSpout" x1="10" y1="22" x2="28" y2="34">
              <stop offset="0%" stopColor="#a3bcc9" />
              <stop offset="100%" stopColor="#8ba4b4" />
            </linearGradient>
          </defs>
          ...
          <g className="wc-body">
            ...
            <ellipse cx="36" cy="28" rx="10" ry="7" fill="#d4e4cc" opacity="0.45" />
            {/* rim */}
            <ellipse cx="36" cy="20" rx="11" ry="4" fill="#a8be92" />
            <ellipse cx="36" cy="19.2" rx="8" ry="2.4" fill="#e8f0e4" opacity="0.55" />
            {/* spout */}
            <path
              d="M24 26 C18 24 12 26 10 30 C9 33 12 35 16 34 C20 33 24 30 26 28Z"
              fill="url(#wcSpout)"
            />
            <ellipse cx="11" cy="31" rx="2.2" ry="1.6" fill="#6d8a8a" />
            {/* cute face on can */}
